...
// ---------- Tasbih (dhikr) list ----------
const TASBIH_LIST = [
  { id: "subhanallah", ar: "سُبْحَانَ اللّٰهِ", en: "Glory be to Allah", meaning: "Allah pak hai har aib se", target: 33 },
  { id: "alhamdulillah", ar: "الْحَمْدُ لِلّٰهِ", en: "All praise is due to Allah", meaning: "Saari tareef Allah ke liye", target: 33 },
  { id: "allahuakbar", ar: "اللّٰهُ أَكْبَرُ", en: "Allah is the Greatest", meaning: "Allah sabse bada hai", target: 34 },
  { id: "lailaha", ar: "لَا إِلٰهَ إِلَّا اللّٰهُ", en: "There is no god but Allah", meaning: "Allah ke siwa koi ibadat ke laayak nahi", target: 100 },
  { id: "astaghfirullah", ar: "أَسْتَغْفِرُ اللّٰهَ", en: "I seek forgiveness from Allah", meaning: "Main Allah se maghfirat maangta/maangti hoon", target: 100 },
  { id: "subhanallahi-wa-bihamdihi", ar: "سُبْحَانَ اللّٰهِ وَبِحَمْدِهِ", en: "Glory be to Allah, and praise be to Him", meaning: "Allah pak hai, aur usi ki tareef ke saath", target: 100 },
  { id: "subhanallahil-azeem", ar: "سُبْحَانَ اللّٰهِ الْعَظِيمِ", en: "Glory be to Allah, the Magnificent", meaning: "Allah pak hai jo azeem hai", target: 100 },
  { id: "la-hawla", ar: "لَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللّٰهِ", en: "There is no power nor strength except with Allah", meaning: "Koi taaqat nahi Allah ke siwa", target: 100 },
  { id: "hasbunallah", ar: "حَسْبُنَا اللّٰهُ وَنِعْمَ الْوَكِيلُ", en: "Allah is sufficient for us, and He is the best disposer of affairs", meaning: "Allah humare liye kaafi hai, wo behtareen kaarsaaz hai", target: 100 },
  { id: "rabbighfirli", ar: "رَبِّ اغْفِرْ لِي", en: "My Lord, forgive me", meaning: "Ae mere Rab, mujhe bakhsh de", target: 100 },
  { id: "durood", ar: "اللّٰهُمَّ صَلِّ عَلَىٰ مُحَمَّدٍ", en: "O Allah, send blessings upon Muhammad", meaning: "Ae Allah, Muhammad (ﷺ) par rehmat nazil farma", target: 100 },
  { id: "la-ilaha-illa-anta", ar: "لَا إِلٰهَ إِلَّا أَنْتَ سُبْحَانَكَ إِنِّي كُنْتُ مِنَ الظَّالِمِينَ", en: "There is no god but You, glory be to You, I have indeed been of the wrongdoers", meaning: "Tere siwa koi ma'bood nahi, tu pak hai, main hi zaalim tha", target: 33 },
  { id: "rabbi-zidni-ilma", ar: "رَبِّ زِدْنِي عِلْمًا", en: "My Lord, increase me in knowledge", meaning: "Ae mere Rab, mera ilm barha de", target: 33 },
  { id: "yaa-hayyu-yaa-qayyum", ar: "يَا حَيُّ يَا قَيُّومُ", en: "O Ever-Living, O Sustainer", meaning: "Ae Zinda, ae Qaayam rehne wale", target: 100 },
  { id: "subhana-rabbiyal-azeem", ar: "سُبْحَانَ رَبِّيَ الْعَظِيمِ", en: "Glory be to my Lord, the Magnificent (ruku)", meaning: "Mera Rab pak hai jo azeem hai (ruku ki tasbih)", target: 33 },
  { id: "subhana-rabbiyal-ala", ar: "سُبْحَانَ رَبِّيَ الْأَعْلَىٰ", en: "Glory be to my Lord, the Most High (sajdah)", meaning: "Mera Rab pak hai jo sabse buland hai (sajda ki tasbih)", target: 33 },
  { id: "rabbana-atina", ar: "رَبَّنَا آتِنَا فِي الدُّنْيَا حَسَنَةً وَفِي الْآخِرَةِ حَسَنَةً", en: "Our Lord, give us good in this world and good in the Hereafter", meaning: "Ae Rab, humein duniya aur aakhirat me bhalaai de", target: 10 },
  { id: "la-ilaha-illallahu-wahdahu", ar: "لَا إِلٰهَ إِلَّا اللّٰهُ وَحْدَهُ لَا شَرِيكَ لَهُ", en: "There is no god but Allah alone, with no partner", meaning: "Allah ke siwa koi ma'bood nahi, wo akela hai, uska koi shareek nahi", target: 100 },
  { id: "yaa-rahman-yaa-raheem", ar: "يَا رَحْمَٰنُ يَا رَحِيمُ", en: "O Most Merciful, O Most Compassionate", meaning: "Ae Rahman, ae Raheem", target: 100 },
  { id: "innalillahi", ar: "إِنَّا لِلّٰهِ وَإِنَّا إِلَيْهِ رَاجِعُونَ", en: "Indeed we belong to Allah, and indeed to Him we will return", meaning: "Hum Allah ke hain aur usi ki taraf lautne wale hain", target: 10 },
];

// ---------- state ----------
let state = {
  dayOffset: 0,
  view: "home", // home | saved | search | about | surah | tasbih | qibla
  searchQuery: "",
  selectedSurah: null,
...
function renderTasbihView() {
  const options = TASBIH_LIST.map(
    (t) => `<option value="${t.id}" ${t.id === state.tasbihId ? "selected" : ""}>${t.meaning.split("(")[0].trim()}</option>`
  ).join("");
...
function requestQibla() {
  state.qiblaError = null;
  state.qiblaLoading = true;
  render();

  if (!navigator.geolocation) {
    state.qiblaLoading = false;
    state.qiblaError = "Is browser mein location support nahi hai.";
    render();
    return;
  }
  ...
  navigator.geolocation.getCurrentPosition(
    (pos) => {
      state.qiblaLoading = false;
      state.qiblaBearing = computeQiblaBearing(pos.coords.latitude, pos.coords.longitude);
      render();
      setupCompassListener();
    },
    () => {
      state.qiblaLoading = false;
      state.qiblaError = "Location access nahi mil paayi. Settings mein jaakar location permission on karein.";
      render();
    },
    ...
    DeviceOrientationEvent.requestPermission()
      .then((resp) => {
        if (resp === "granted") {
          ...
          state.qiblaError = "Compass ke liye permission nahi mili. Aap neeche diye degree ka istemaal karke Qibla dhoondh sakte hain.";
          render();
        }
      })
      .catch(() => {});
...
function updateNeedleRotation(deviceHeading) {
  const needle = document.getElementById("qiblaNeedle");
  if (!needle || state.qiblaBearing == null) return;
  const rotation = state.qiblaBearing - deviceHeading;
  needle.style.transform = `rotate(${rotation}deg)`;
}

function renderQiblaView() {
  if (state.qiblaBearing == null) {
    return `
      <div class="qibla-wrap">
        <div class="qibla-status">
          ${state.qiblaLoading ? "Location dhoondi jaa rahi hai…" : (state.qiblaError || "Qibla (Mecca) ki sahi disha dekhne ke liye apni location ki ijazat dein.")}
        </div>
        <button class="qibla-enable-btn" onclick="requestQibla()" ${state.qiblaLoading ? "disabled" : ""}>Qibla Dhoondein</button>
      </div>
    `;
  }
  return `
    <div class="qibla-wrap">
      <div class="qibla-degrees">${Math.round(state.qiblaBearing)}°</div>
      <div class="qibla-degrees-sub">Qibla ki disha (True North se)</div>
      <div class="qibla-compass">
        <div class="qibla-kaaba-icon"></div>
        <div class="qibla-needle" id="qiblaNeedle" style="transform: rotate(${state.qiblaBearing}deg)">
          <div class="qibla-needle-shape"></div>
        </div>
      </div>
      <div class="qibla-status">Apna phone seedha rakhein aur ghumaayein — jab gold nishaan seedha upar ho, tab aap Qibla ki taraf mooh kiye hue hain.<br><br>Agar compass move na ho, phone ko figure-8 shape mein hilaayein taaki sensor calibrate ho jaaye.</div>
    </div>
  `;
}
...
function render() {
  ...
  document.getElementById("navQibla").classList.toggle("active", state.view === "qibla");
...
function renderMainContent() {
  ...
  if (state.view === "qibla") {
    container.innerHTML = renderQiblaView();
    if (state.qiblaBearing != null) updateNeedleRotation(0);
    return;
  }
