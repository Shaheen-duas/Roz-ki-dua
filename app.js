...
// ---------- Tasbih (dhikr) list ----------
const TASBIH_LIST = [
  { id: "subhanallah", ar: "سُبْحَانَ اللّٰهِ", meaning: "Allah pak hai har aib se", target: 33 },
  { id: "alhamdulillah", ar: "الْحَمْدُ لِلّٰهِ", meaning: "Saari tareef Allah ke liye", target: 33 },
  { id: "allahuakbar", ar: "اللّٰهُ أَكْبَرُ", meaning: "Allah sabse bada hai", target: 34 },
  { id: "lailaha", ar: "لَا إِلٰهَ إِلَّا اللّٰهُ", meaning: "Allah ke siwa koi ibadat ke laayak nahi", target: 100 },
  { id: "astaghfirullah", ar: "أَسْتَغْفِرُ اللّٰهَ", meaning: "Main Allah se maghfirat maangta/maangti hoon", target: 100 },
  { id: "subhanallahi-wa-bihamdihi", ar: "سُبْحَانَ اللّٰهِ وَبِحَمْدِهِ", meaning: "Allah pak hai, aur usi ki tareef ke saath", target: 100 },
  { id: "subhanallahil-azeem", ar: "سُبْحَانَ اللّٰهِ الْعَظِيمِ", meaning: "Allah pak hai jo azeem hai", target: 100 },
  { id: "la-hawla", ar: "لَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللّٰهِ", meaning: "Koi taaqat nahi Allah ke siwa", target: 100 },
  { id: "hasbunallah", ar: "حَسْبُنَا اللّٰهُ وَنِعْمَ الْوَكِيلُ", meaning: "Allah humare liye kaafi hai, wo behtareen kaarsaaz hai", target: 100 },
  { id: "rabbighfirli", ar: "رَبِّ اغْفِرْ لِي", meaning: "Ae mere Rab, mujhe bakhsh de", target: 100 },
  { id: "durood", ar: "اللّٰهُمَّ صَلِّ عَلَىٰ مُحَمَّدٍ", meaning: "Ae Allah, Muhammad (ﷺ) par rehmat nazil farma", target: 100 },
  { id: "la-ilaha-illa-anta", ar: "لَا إِلٰهَ إِلَّا أَنْتَ سُبْحَانَكَ إِنِّي كُنْتُ مِنَ الظَّالِمِينَ", meaning: "Tere siwa koi ma'bood nahi, tu pak hai, main hi zaalim tha", target: 33 },
  { id: "rabbi-zidni-ilma", ar: "رَبِّ زِدْنِي عِلْمًا", meaning: "Ae mere Rab, mera ilm barha de", target: 33 },
  { id: "yaa-hayyu-yaa-qayyum", ar: "يَا حَيُّ يَا قَيُّومُ", meaning: "Ae Zinda, ae Qaayam rehne wale", target: 100 },
  { id: "subhana-rabbiyal-azeem", ar: "سُبْحَانَ رَبِّيَ الْعَظِيمِ", meaning: "Mera Rab pak hai jo azeem hai (ruku ki tasbih)", target: 33 },
  { id: "subhana-rabbiyal-ala", ar: "سُبْحَانَ رَبِّيَ الْأَعْلَىٰ", meaning: "Mera Rab pak hai jo sabse buland hai (sajda ki tasbih)", target: 33 },
  { id: "rabbana-atina", ar: "رَبَّنَا آتِنَا فِي الدُّنْيَا حَسَنَةً وَفِي الْآخِرَةِ حَسَنَةً", meaning: "Ae Rab, humein duniya aur aakhirat me bhalaai de", target: 10 },
  { id: "la-ilaha-illallahu-wahdahu", ar: "لَا إِلٰهَ إِلَّا اللّٰهُ وَحْدَهُ لَا شَرِيكَ لَهُ", meaning: "Allah ke siwa koi ma'bood nahi, wo akela hai, uska koi shareek nahi", target: 100 },
  { id: "yaa-rahman-yaa-raheem", ar: "يَا رَحْمَٰنُ يَا رَحِيمُ", meaning: "Ae Rahman, ae Raheem", target: 100 },
  { id: "innalillahi", ar: "إِنَّا لِلّٰهِ وَإِنَّا إِلَيْهِ رَاجِعُونَ", meaning: "Hum Allah ke hain aur usi ki taraf lautne wale hain", target: 10 },
];
